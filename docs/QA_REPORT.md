...
## 7. Addendum: response to the external audit (2026-08-09)

An independent external audit (2026-08-08) confirmed the happy path and the
design, and found six P1 data-integrity defects plus a set of P2
