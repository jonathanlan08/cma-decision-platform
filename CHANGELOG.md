...
- **Fail-closed provenance and repair completeness** (fourth audit round,
  2026-08-09):
...
- **Full calculation provenance** (third external audit round, 2026-08-09):
  - The suggestion-outdatedness check now fingerprints ALL inputs that shape
    ...
    comparable's priced fields. Editing the subject's square footage (the
    audit's reproduced case), a comparable's sale price, or adding a
